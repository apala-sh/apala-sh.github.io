...
![img1](/assets/images/RootMe/Pasted%20image%2020250711160201.png)
...
![img2](/assets/images/RootMe/Screenshot%20from%202025-07-11%2013-50-44%201.png)
...
![img3](/assets/images/RootMe/Pasted%20image%2020250711162654.png)
...
![img4](/assets/images/RootMe/Screenshot%20from%202025-07-11%2013-56-28.png)



- `http://<target_IP>/uploads` $\rightarrow$ the directory where we can potentially see the files uploaded  

![img5](/assets/images/RootMe/Screenshot%20from%202025-07-11%2013-56-54.png)
...
![img6](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-02-39.png)

After configuring the file save and upload it

![img7](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-04-06.png)

![img8](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-03-52.png)
...
![img9](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-04-36.png)

uploading this renamed file:

![img10](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-05-01.png)

Success !!!

We can find our uploaded file in the `/uploads` directory

![img11](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-05-19.png)

Before executing this we need to open a `netcat` listener 

![img12](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-05-42.png)

Once the listener is listening, execute the uploaded file and we will receive a connection on our terminal.

![img13](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-06-00.png)

We can upgrade the shell using the `pty` python library

`python -c 'import pty; pty.spawn("/bin/bash")'`

![img14](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-13-42.png)

Use `find` to locate the `user.txt` file

![img15](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-14-47.png)

`cat` the file to obtain the flag

![img16](/assets/images/RootMe/Pasted%20image%2020250711192121.png)
...
![img17](/assets/images/RootMe/Pasted%20image%2020250726234505.png)
...
![img18](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-17-29.png)
![img19](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-17-49.png)

Use the command to escalate privilege to `root`

![img20](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-21-24.png)

Find the `root.txt` file:

![img21](/assets/images/RootMe/Screenshot%20from%202025-07-11%2014-22-59.png)

`cat` the `root.txt` file to capture the last flag:
![img22](/assets/images/RootMe/Pasted%20image%2020250726235717.png)